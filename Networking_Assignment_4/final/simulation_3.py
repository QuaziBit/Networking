...
if __name__ == '__main__':
    ...
    cost_D = {'RA': {0: 1}, 'RD': {1: 5}} # {neighbor: {interface: cost}}
    ...
    cost_D = {'H2': {2: 3}, 'RB': {0: 5}, 'RC': {1: 10}} # {neighbor: {interface: cost}}
    ...
    router_a.send_routes() #one update starts the routing process
