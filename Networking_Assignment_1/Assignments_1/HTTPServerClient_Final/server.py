...
class httpServerHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        try:
            ...
            if self.path.endswith("/js/opponent_board.js"):
                ...
                scriptPath = os.path.realpath(__file__)
                homeFolderPath = os.path.dirname(scriptPath)
                jsPath = "%s\js\opponent_board.js" % (homeFolderPath)
    ...
    webPage = """
                ...
                <html lang="en">
                    ...
                    <body>
                        ...
                        <script src="js/jquery_2_2_4_min.js" type="text/javascript"></script>
                        <script src="js/opponent_board.js" type="text/javascript"></script>
                    </body>
                </html>""" % (html)
